...
public class Reader {
    static String[] read(String[] argv) {
        ...
        // String filePath = "test/subtask04-assigment/testcase02.out";
        // String filePath = "test/subtask05-casting/testcase02.out";
        // String filePath = "test/subtask06-if/testcase01.out";
        // String filePath = "test/subtask07-while/testcase01.out";
